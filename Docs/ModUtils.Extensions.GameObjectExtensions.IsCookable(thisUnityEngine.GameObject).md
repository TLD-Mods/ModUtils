...
## GameObjectExtensions.IsCookable(this GameObject) Method

Shorthand for HasComponent<Cookable>

```csharp
internal static bool IsCookable(this UnityEngine.GameObject go);
```
#### Parameters

<a name='ModUtils.Extensions.GameObjectExtensions.IsCookable(thisUnityEngine.GameObject).go'></a>
